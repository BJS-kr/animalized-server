...
func (Operation_Direction) EnumDescriptor() ([]byte, []int) {
	return file_message_proto_input_proto_rawDescGZIP(), []int{3, 0}
}
...
func (Operation_OperationType) EnumDescriptor() ([]byte, []int) {
	return file_message_proto_input_proto_rawDescGZIP(), []int{3, 1}
}
...
type Terrain_TerrainType int32

const (
	Terrain_TERRAIN_UNSPECIFIED Terrain_TerrainType = 0
	Terrain_ROCK                Terrain_TerrainType = 1
)

// Enum value maps for Terrain_TerrainType.
var (
	Terrain_TerrainType_name = map[int32]string{
		0: "TERRAIN_UNSPECIFIED",
		1: "ROCK",
	}
	Terrain_TerrainType_value = map[string]int32{
		"TERRAIN_UNSPECIFIED": 0,
		"ROCK":                1,
	}
)

func (x Terrain_TerrainType) Enum() *Terrain_TerrainType {
	p := new(Terrain_TerrainType)
	*p = x
	return p
}

func (x Terrain_TerrainType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Terrain_TerrainType) Descriptor() protoreflect.EnumDescriptor {
	return file_message_proto_input_proto_enumTypes[6].Descriptor()
}

func (Terrain_TerrainType) Type() protoreflect.EnumType {
	return &file_message_proto_input_proto_enumTypes[6]
}

func (x Terrain_TerrainType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Terrain_TerrainType.Descriptor instead.
func (Terrain_TerrainType) EnumDescriptor() ([]byte, []int) {
	return file_message_proto_input_proto_rawDescGZIP(), []int{8, 0}
}

type Terrain_TerrainState int32

const (
	Terrain_TERRAIN_STATE_UNSPECIFIED Terrain_TerrainState = 0
	Terrain_SOLID                     Terrain_TerrainState = 1
	Terrain_DAMAGED                   Terrain_TerrainState = 2
	Terrain_VULNERABLE                Terrain_TerrainState = 3
	Terrain_DESTROYED                 Terrain_TerrainState = 4
)

// Enum value maps for Terrain_TerrainState.
var (
	Terrain_TerrainState_name = map[int32]string{
		0: "TERRAIN_STATE_UNSPECIFIED",
		1: "SOLID",
		2: "DAMAGED",
		3: "VULNERABLE",
		4: "DESTROYED",
	}
	Terrain_TerrainState_value = map[string]int32{
...
func (x Terrain_TerrainState) Enum() *Terrain_TerrainState {
	p := new(Terrain_TerrainState)
	*p = x
	return p
}

func (x Terrain_TerrainState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Terrain_TerrainState) Descriptor() protoreflect.EnumDescriptor {
	return file_message_proto_input_proto_enumTypes[7].Descriptor()
}

func (Terrain_TerrainState) Type() protoreflect.EnumType {
	return &file_message_proto_input_proto_enumTypes[7]
}

func (x Terrain_TerrainState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Terrain_TerrainState.Descriptor instead.
func (Terrain_TerrainState) EnumDescriptor() ([]byte, []int) {
	return file_message_proto_input_proto_rawDescGZIP(), []int{8, 1}
}
...
func (x *Input) GetGameResult() *GameResult {
	if x, ok := x.GetKind().(*Input_GameResult); ok {
		return x.GameResult
	}
	return nil
}
...
type Input_GameResult struct {
	GameResult *GameResult `protobuf:"bytes,6,opt,name=game_result,json=gameResult,proto3,oneof"`
}
...
func (*Input_GameResult) isInput_Kind() {}
...
type Operation struct {
	...
	TargetTerrainId int32  `protobuf:"varint,6,opt,name=target_terrain_id,json=targetTerrainId,proto3" json:"target_terrain_id,omitempty"`
	ProjectileId    int32  `protobuf:"varint,7,opt,name=projectile_id,json=projectileId,proto3" json:"projectile_id,omitempty"`
	Context         int64  `protobuf:"varint,8,opt,name=context,proto3" json:"context,omitempty"`
	PrevContext     int64  `protobuf:"varint,9,opt,name=prev_context,json=prevContext,proto3" json:"prev_context,omitempty"`
}
...
func (x *Operation) GetTargetTerrainId() int32 {
	if x != nil {
		return x.TargetTerrainId
	}
	return 0
}
...
type Room struct {
	...
	Terrains           []*Terrain                    `protobuf:"bytes,6,rep,name=terrains,proto3" json:"terrains,omitempty"`
}
...
func (x *Room) GetTerrains() []*Terrain {
	if x != nil {
		return x.Terrains
	}
	return nil
...
func (*GameResult) Descriptor() ([]byte, []int) {
	return file_message_proto_input_proto_rawDescGZIP(), []int{7}
}
...
func (x *GameResult) GetRoomName() string {
	if x != nil {
		return x.RoomName
	}
	return ""
...
type Terrain struct {
	...
	Type     Terrain_TerrainType  `protobuf:"varint,1,opt,name=type,proto3,enum=input.Terrain_TerrainType" json:"type,omitempty"`
	State    Terrain_TerrainState `protobuf:"varint,2,opt,name=state,proto3,enum=input.Terrain_TerrainState" json:"state,omitempty"`
...
func (*Terrain) Descriptor() ([]byte, []int) {
	return file_message_proto_input_proto_rawDescGZIP(), []int{8}
}

func (x *Terrain) GetType() Terrain_TerrainType {
	if x != nil {
		return x.Type
	}
...
func (x *Terrain) GetState() Terrain_TerrainState {
	if x != nil {
		return x.State
	}
	return Terrain_TERRAIN_STATE_UNSPECIFIED
}

func (x *Terrain) GetPosition() *Position {
	if x != nil {
		return x.Position
	}
	return nil
...
func (x *Operation_GameState) Reset() {
	*x = Operation_GameState{}
	mi := &file_message_proto_input_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Operation_GameState_UserState) Reset() {
	*x = Operation_GameState_UserState{}
	mi := &file_message_proto_input_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Operation_GameState_UserState) Descriptor() ([]byte, []int) {
	return file_message_proto_input_proto_rawDescGZIP(), []int{3, 1, 0}
}
...
var file_message_proto_input_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x22, 0xee, 0x01, 0x0a, 0x05, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x17, 0x0a, 0x07,
	...
	0x04, 0x72, 0x6f, 0x6f, 0x6d, 0x12, 0x34, 0x0a, 0x0b, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x72, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x69, 0x6e, 0x70,
	0x75, 0x74, 0x2e, 0x47, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x48, 0x00, 0x52,
	0x0a, 0x67, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x06, 0x0a, 0x04, 0x6b,
	0x69, 0x6e, 0x64, 0x22, 0x06, 0x0a, 0x04, 0x49, 0x6e, 0x69, 0x74, 0x22, 0x26, 0x0a, 0x08, 0x50,
	...
	,
	...
	,
	...
	0x52, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x4d, 0x0a, 0x09, 0x44, 0x69, 0x72, 0x65, 0x63,
	...
	0x49, 0x47, 0x48, 0x54, 0x10, 0x04, 0x22, 0x59, 0x0a, 0x0d, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0xb1, 0x02, 0x0a, 0x07, 0x54, 0x65, 0x72, 0x72, 0x61, 0x69, 0x6e, 0x12, 0x2e, 0x0a, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x69, 0x6e, 0x70,
	0x75, 0x74, 0x2e, 0x54, 0x65, 0x72, 0x72, 0x61, 0x69, 0x6e, 0x2e, 0x54, 0x65, 0x72, 0x72, 0x61,
	0x69, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x31, 0x0a, 0x05,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x69, 0x6e,
	0x70, 0x75, 0x74, 0x2e, 0x54, 0x65, 0x72, 0x72, 0x61, 0x69, 0x6e, 0x2e, 0x54, 0x65, 0x72, 0x72,
	...
	,
...
var file_message_proto_input_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_message_proto_input_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_message_proto_input_proto_goTypes = []any{
	...
	(Terrain_TerrainType)(0),              // 6: input.Terrain.TerrainType
	(Terrain_TerrainState)(0),             // 7: input.Terrain.TerrainState
	(*Input)(nil),                         // 8: input.Input
	(*Init)(nil),                          // 9: input.Init
	(*Position)(nil),                      // 10: input.Position
	(*Operation)(nil),                     // 11: input.Operation
	(*RoomState)(nil),                     // 12: input.RoomState
	(*Lobby)(nil),                         // 13: input.Lobby
	(*Room)(nil),                          // 14: input.Room
	(*GameResult)(nil),                    // 15: input.GameResult
	(*Terrain)(nil),                       // 16: input.Terrain
	(*Operation_HitRange)(nil),            // 17: input.Operation.HitRange
	(*Operation_GameState)(nil),           // 18: input.Operation.GameState
	(*Operation_GameState_UserState)(nil), // 19: input.Operation.GameState.UserState
	nil,                                   // 20: input.Room.UserCharacterTypesEntry
}
var file_message_proto_input_proto_depIdxs = []int32{
	9,  // 0: input.Input.init:type_name -> input.Init
	11, // 1: input.Input.op:type_name -> input.Operation
	13, // 2: input.Input.lobby:type_name -> input.Lobby
	14, // 3: input.Input.room:type_name -> input.Room
	15, // 4: input.Input.game_result:type_name -> input.GameResult
	1,  // 5: input.Operation.type:type_name -> input.Operation.OperationType
	0,  // 6: input.Operation.direction:type_name -> input.Operation.Direction
	17, // 7: input.Operation.hit_range:type_name -> input.Operation.HitRange
	18, // 8: input.Operation.game_state:type_name -> input.Operation.GameState
	2,  // 9: input.RoomState.status:type_name -> input.RoomState.RoomStatusType
	3,  // 10: input.Lobby.type:type_name -> input.Lobby.LobbyType
	12, // 11: input.Lobby.room_states:type_name -> input.RoomState
	4,  // 12: input.Room.type:type_name -> input.Room.RoomType
	12, // 13: input.Room.room_state:type_name -> input.RoomState
	20, // 14: input.Room.user_character_types:type_name -> input.Room.UserCharacterTypesEntry
	16, // 15: input.Room.terrains:type_name -> input.Terrain
	6,  // 16: input.Terrain.type:type_name -> input.Terrain.TerrainType
	7,  // 17: input.Terrain.state:type_name -> input.Terrain.TerrainState
	10, // 18: input.Terrain.position:type_name -> input.Position
	10, // 19: input.Operation.HitRange.left_bottom:type_name -> input.Position
	10, // 20: input.Operation.HitRange.right_top:type_name -> input.Position
	19, // 21: input.Operation.GameState.user_states:type_name -> input.Operation.GameState.UserState
	10, // 22: input.Operation.GameState.UserState.position:type_name -> input.Position
	5,  // 23: input.Room.UserCharacterTypesEntry.value:type_name -> input.Room.CharacterType
